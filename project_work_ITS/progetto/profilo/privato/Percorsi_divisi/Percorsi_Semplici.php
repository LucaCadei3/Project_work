<html>
    ...
    <body>
        <div class="rifugio">
            <p><h3>Percorsi trovati di difficolt&agrave; semplice: </h3></p>
            <h1>Bergamo</h1>
            ...
            <?php
                ...
                $sql = "SELECT * FROM rifugi WHERE Provincia='Bergamo' AND Difficolta='semplici'";
            ...
            <?php
                ...
                $sql = "SELECT * FROM rifugi WHERE Provincia='Brescia' AND Difficolta='semplici'";
                $result = mysqli_query($connessione,$sql);
            ...
            <?php
                ...
                $sql = "SELECT * FROM rifugi WHERE Provincia='Lecco_Como' AND Difficolta='semplici'";
                $result = mysqli_query($connessione,$sql);
            ...
            <?php
                ...
                $sql = "SELECT * FROM rifugi WHERE Provincia='Sondrio' AND Difficolta='semplici'";
                $result = mysqli_query($connessione,$sql);
