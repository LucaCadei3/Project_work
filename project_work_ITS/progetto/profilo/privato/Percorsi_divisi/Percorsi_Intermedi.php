<html>
    ...
    <body>
        <div class="rifugio">
            <p><h3>Percorsi trovati di difficolt&agrave; intermeda: </h3></p>
            ...
            <?php
                ...
                $sql = "SELECT * FROM rifugi WHERE Provincia='Bergamo' AND Difficolta='intermedi'";
            ...
            <?php
                ...
                $sql = "SELECT * FROM rifugi WHERE Provincia='Brescia' AND Difficolta='intermedi'";
                $result = mysqli_query($connessione,$sql);
            ...
            <?php
                ...
                $sql = "SELECT * FROM rifugi WHERE Provincia='Lecco_Como' AND Difficolta='intermedi'";
                $result = mysqli_query($connessione,$sql);
            ...
            <?php
                ...
                $sql = "SELECT * FROM rifugi WHERE Provincia='Sondrio' AND Difficolta='intermedi'";
                $result = mysqli_query($connessione,$sql);
